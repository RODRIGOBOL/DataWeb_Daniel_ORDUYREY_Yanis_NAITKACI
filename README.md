Voici une version **ultra-détaillée** de ton `README.md`. Elle est structurée pour montrer au correcteur que vous maîtrisez toute la chaîne technique, de l'extraction de texte brut au raisonnement par IA.
